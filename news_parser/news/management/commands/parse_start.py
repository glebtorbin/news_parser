...
def parse():
    ...
    links = blocks.find_all(
        'a',
        class_='link link_theme_normal news-list__item-active i-bem'
    )[:10]
    url_list = []
    title_list = []
    info_list = []
    ...
    for content in url_list:
        ...
        info = soup.find(
            "div", class_="news-info__post-body html-content page-content"
        ).text
